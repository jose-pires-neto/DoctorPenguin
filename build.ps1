...
pyinstaller --noconsole --onefile --name "DoctorPenguin" --add-data "penguin_sprites_aligned.png;." --add-data "icon.ico;." --add-data "icon.png;." --icon "icon.ico" --hidden-import "pyttsx3.drivers" --hidden-import "pyttsx3.drivers.sapi5" --hidden-import "edge_tts" --hidden-import "aiohttp" main.py
